...
经过训练的代理的最终表现可以在下表中找到。
这是通过运行 `python -m rl_zoo3.benchmark` 计算得出的：
它为 `eval_timesteps` 运行经过训练的代理（在 `n_timesteps` 上训练），然后报告平均剧集奖励
本次评价期间。

它使用确定性策略（Atari 游戏除外）。

您可以查看每个模型卡（包括视频和超参数）
在我们的 Huggingface 页面上：https://huggingface.co/sb3

*注意：这不是定量基准，因为它仅对应于一次运行
（参见[问题＃38]（https://github.com/araffin/rl-baselines-zoo/issues/38））。
该基准测试旨在检查算法（最大）性能，发现潜在的错误
并允许用户访问经过预训练的代理。*

“M”代表百万 (1e6)

|  算法|            env_id |mean_reward|std_reward|n_timesteps|eval_timesteps|eval_episodes|
|--------|-------------------------------|----------:|---------:|-----------|-------------:|------------:|
|a2c |Acrobot-v1 |    -83.353|    17.213|50万|        149979|         1778|
...
|a2c |Humanoid-v3 |    388.321|    92.652|2M|        149942|         1944年|
|a2c |LunarLander-v2 |    155.751|    80.419|20万|        149443|          297|
|a2c |LunarLanderContinously-v2 |     84.225|   145.906|5M|        149305|          256|
|a2c |MountainCar-v0 |   -111.263|    24.087|1M |        149982|         1348|
|a2c |MountainCarContinously-v0 |     91.166|     0.255|10万|        149923|         1659|
...
|ars |Acrobot-v1 |    -82.884|    23.825|50万|        149985|         1788|
...
|ars |LunarLanderContinously-v2 |    167.959|   147.071|2M |        149883|          562|
|ars |MountainCar-v0 |   -122.000|    33.456|50万|        149938|         1229|
|ars |MountainCarContinously-v0 |     96.672|     0.784|50万|        149990|          621|
...
|ddpg |LunarLanderContinously-v2 |    230.217|    92.372|30万|        149862|          556|
|ddpg |MountainCarContinously-v0 |     93.512|     0.048|30万|        149965|         2260|
|ddpg |Pendulum-v1 |   -152.099|    94.282|20k |        150000|          750|
|ddpg |ReacherBulletEnv-v0 |     15.582|     9.606|30万|        150000|         1000|
|ddpg |Walker2DBulletEnv-v0 |   1387.591|   736.955|1M|        149051|          208|
|dqn |Acrobot-v1 |    -76.639|    11.752|10万|        149998|         1932年|
...
|dqn |LunarLander-v2 |    154.382|    79.241|10万|        149373|          200|
|dqn |MountainCar-v0 |   -100.849|     9.925|12万|        149962|         1487|
...
|ppo |Acrobot-v1 |    -73.506|    18.201|1M|        149979|         2013年|
...
|ppo |LunarLanderContinously-v2 |    270.863|    32.072|1M |        149956|          526|
|ppo |MiniGrid-DoorKey-5x5-v0 |      0.964|     0.006|10万|        149994|        14956|
|ppo |MiniGrid-空-随机-5x5-v0 |      0.968|     0.013|10万|        149999|        41965|
|ppo |MiniGrid-FourRooms-v0 |      0.573|     0.311|5M|        149927|         3270|
|ppo |MiniGrid-GoToDoor-5x5-v0 |      0.525|     0.476|5M|        149991|        16918|
|ppo |MiniGrid-KeyCorridorS3R1-v0 |      0.949|     0.011|50万|        149990|         9733|
...
|ppo |MiniGrid-Unlock-v0 |      0.963|     0.016|10万|        149999|        12646|
|ppo |MountainCar-v0 |   -110.423|    19.473|1M|        149954|         1358|
|ppo |MountainCarContinously-v0 |     88.343|     2.572|20k |        149983|          633|
|ppo |MsPacmanNoFrameskip-v4 |   1754.356|   172.783|10M|        600822|          163|
|ppo |Pendulum-v1 |   -172.225|   104.159|10万|        150000|          750|
...
|ppo_lstm|MountainCarContinouslyNoVel-v0 |     91.469|     1.776|30万|        149882|         1340|
|ppo_lstm|PendulumNoVel-v1 |   -217.933|   140.094|100k |        150000|          750|
|qrdqn |Acrobot-v1 |    -69.135|     9.967|10万|        149949|         2138|
...
|qrdqn |LunarLander-v2 |     70.236|   225.491|10万|        149957|          522|
...
|sac |BipedalWalker-v3 |    297.668|    33.060|50万|        149530|          136|
...
|sac |LunarLanderContinously-v2 |    260.390|    65.467|50万|        149634|          672|
|sac |MountainCarContinously-v0 |     94.679|     1.134|5万|        149966|         1443|
|sac |Pendulum-v1 |   -156.995|    88.714|20k |        150000|          750|
|sac |ReacherBulletEnv-v0 |     18.062|     9.729|30万|        150000|         1000|
...
|td3 |LunarLanderContinously-v2 |    207.451|    67.562|30万|        149488|          337|
|td3 |MountainCarContinously-v0 |     93.483|     0.075|30万|        149976|         2275|
|td3 |摆锤-v1 |   -151.855|    90.227|20k |        150000|          750|
|td3 |ReacherBulletEnv-v0 |     17.114|     9.750|30万|        150000|         1000|
...
|tqc |BipedalWalker-v3 |    329.808|    45.083|50万|        149682|          254|
...
|tqc |LunarLanderContinously-v2 |    277.956|    25.466|50万|        149928|          706|
|tqc |MountainCarContinously-v0 |     63.641|    45.259|50k |        149796|          186|
...
|tqc |ReacherBulletEnv-v0 |     18.255|     9.543|30万|        150000|         1000|
...
|tqc |停车-v0 |     -6.762|     2.690|10万|        149983|         7528|
|trpo |Acrobot-v1 |    -83.114|    18.648|10万|        149976|         1783|
...
|trpo |LunarLander-v2 |    133.166|   112.173|20万|        149088|          230|
|trpo |LunarLanderContinously-v2 |    262.387|    21.428|20万|        149925|          501|
|trpo |MountainCar-v0 |   -107.278|    13.231|10万|        149974|         1398|
|trpo |MountainCarContinously-v0 |     92.489|     0.355|5万|        149971|         1732|
|trpo |Pendulum-v1 |   -174.631|   127.577|10万|        150000|          750|
|trpo |ReacherBulletEnv-v0 |     14.741|    11.559|30万|        150000|         1000|
